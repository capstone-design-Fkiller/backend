...
class Major(models.Model): # 관리자들이 설정하는 학과 정보
    ...
    priority_1 = models.ForeignKey(Priority, related_name="priority_1", on_delete=models.PROTECT, db_column="priority_1", null=True, blank=True)
    priority_2 = models.ForeignKey(Priority, related_name="priority_2", on_delete=models.PROTECT, db_column="priority_2", null=True, blank=True)
    priority_3 = models.ForeignKey(Priority, related_name="priority_3", on_delete=models.PROTECT, db_column="priority_3", null=True, blank=True)
